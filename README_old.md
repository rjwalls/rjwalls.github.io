...
1. Install the dependencies. You will need [Python][], [Pybtex][] (`pip install pybtex`), [Jinja2][] (`pip install jinja2`), and [Jekyll][] (`gem install jekyll`).
